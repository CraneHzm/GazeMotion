...
class Player_Skeleton:
    def __init__(self, fps=30.0):
        ...
        self._fps = fps
        # names of all the 23 joints + gaze + intention
    ...
    def play_xyz(self, pose_xyz, gaze, head):
        gaze_direction = pose_xyz[:, 15*3:16*3] + gaze*0.5
        head_direction = pose_xyz[:, 15*3:16*3] + head*0.5
...
if __name__ == "__main__":
    data_path = "/scratch/hu/pose_forecast/gimo_gazemotion/train/bedroom0122_2022-01-21-195107_398_"
